...
export default function NonRestoringPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden opacity-20">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-purple-500 rounded-full filter blur-[100px]"></div>
        <div className="absolute top-1/3 -right-40 w-80 h-80 bg-purple-400 rounded-full filter blur-[100px]"></div>
        <div className="absolute -bottom-40 left-1/3 w-80 h-80 bg-purple-300 rounded-full filter blur-[100px]"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto py-8 px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-3xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-purple-500 text-transparent bg-clip-text">
              Non-Restoring Division Algorithm Visualizer
            </h1>
            <p className="text-gray-300 mb-8 max-w-2xl">
              Explore the step-by-step process of the Non-Restoring Division algorithm with interactive visualizations.
              This algorithm is an optimization of the restoring algorithm that avoids the restore step.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-black/90 to-black/70 backdrop-blur-md rounded-xl p-6 border border-purple-500/20 shadow-xl shadow-purple-500/5"
          >
